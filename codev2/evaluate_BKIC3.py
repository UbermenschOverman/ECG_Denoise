...
# Files to process
FILES_TO_PROCESS = [
    "100326_fecg_thuonghtk_tim.txt",
    "270226_thuonghtk1_tim.txt"
]
...
def process_bkic3(depth, model_filename, output_subdir, raw_dir, model_dir_path):
    print(f"\n🚀 Processing datasetBKIC3 for Depth {depth}")
    ...
    for filename in FILES_TO_PROCESS:
        ...
        print(f"   ✅ Processed {filename} (CSV & PNG)")
...
if __name__ == "__main__":
    ...
    MAIN_OUT_DIR = os.path.join(ECG_ROOT, "evaluation_outputs_BKIC3")
